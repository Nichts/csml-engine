...
impl BotOpt {
    pub async fn search_bot_async(&self, db: &mut AsyncDatabase<'_>) -> Result<CsmlBot, EngineError> {
        match self {
            ...
            BotOpt::Id {
                ...
                let bot_version = db_connectors::bot::get_by_version_id(version_id, bot_id, db).await?;
